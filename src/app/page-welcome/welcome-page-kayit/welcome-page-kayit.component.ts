...
@Component({
  selector: 'app-welcome-page-kayit',
  templateUrl: './welcome-page-kayit.component.html',
  styleUrls: ['./welcome-page-kayit.component.css']
})
export class WelcomePageKayitComponent {
  ...
  async codeSend() {
    ...
    user.phone = phone
    user.istek_tip = "new_signup"

    ok = await this.signUpService.sendCode(user)
  ...
  async sendSignUpCode() {
    ...
    ok = await this.signUpService.sendCodeIsOk(user)
